...
declare namespace Framework7 {
    ...
    interface DeviceInfo {
        ...
        /*
         Contains version of operating system. Available only for Android and iOS devices.
         For example, if it is iOS device with iOS version 7.1 then it will contain "7.1".
         */
        osVersion: string;
        ...
        /*
         Contains true if minimal-ui mode is enabled:
         web app running in browser on iPhone/iPod with iOS 7.1+ and minimal-ui viewport meta tag value.
         */
        minimalUi: boolean;
